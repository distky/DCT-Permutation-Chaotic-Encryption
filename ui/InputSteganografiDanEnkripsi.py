...
class Ui_InputSteganografiDanEnkripsi(object):
    def setupUi(self, InputSteganografiDanEnkripsi):
        ...
        self.citraEncryptedView = QtWidgets.QGraphicsView(InputSteganografiDanEnkripsi)
        self.citraEncryptedView.setGeometry(QtCore.QRect(520, 290, 241, 311))
        self.citraEncryptedView.setObjectName("citraEncryptedView")
