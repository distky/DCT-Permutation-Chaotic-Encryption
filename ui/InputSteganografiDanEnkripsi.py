...
class Ui_InputSteganografiDanEnkripsi(object):
    def setupUi(self, InputSteganografiDanEnkripsi):
        ...
        self.doubleSpinBoxY0.setDecimals(5)
        self.doubleSpinBoxY0.setMaximum(1.0)
        self.doubleSpinBoxY0.setSingleStep(1e-05)
        ...
        self.citraSteganoView.setGeometry(QtCore.QRect(520, 290, 241, 311))
        ...
        self.btnsave.setGeometry(QtCore.QRect(490, 650, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
