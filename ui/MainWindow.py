...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnSteganografiEnkripsi.setGeometry(QtCore.QRect(230, 30, 181, 91))
        ...
        self.btnExtractDecrypt.setGeometry(QtCore.QRect(230, 140, 181, 91))
        self.btnExtractDecrypt.setObjectName("btnExtractDecrypt")
        self.btnCompare = QtWidgets.QPushButton(self.centralwidget)
        self.btnCompare.setGeometry(QtCore.QRect(230, 250, 181, 91))
        self.btnCompare.setObjectName("btnCompare")
        self.btnPengujian = QtWidgets.QPushButton(self.centralwidget)
        self.btnPengujian.setGeometry(QtCore.QRect(230, 360, 181, 91))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnPengujian.setText(_translate("MainWindow", "Pengujian"))
